...
% August, 2015
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
cd C:\Users\Jrxz12\Desktop\tax_progressivity\AMTR_construction\mertens_olea
clear all; close all; 
...
AMIITR   = xlsread('output/AMIITRs.xls');
...
cd 'C:\Users\Jrxz12\Desktop\tax_progressivity\AMTR_construction\mertens_olea\auxiliary files'
load D
DW = D;
...
% Interpolate Wages and Salaries for MFJ for 1946-1953
 ...
 % Interpolate Wages and Salaries for MFJ for 2003-2017
...
cd C:\Users\Jrxz12\Desktop\tax_progressivity\AMTR_construction\mertens_olea\output
